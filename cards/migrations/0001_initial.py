...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mistake_in', models.CharField(blank=True, choices=[(None, 'Выберите в чем ошибка'), ('a', 'терминe'), ('b', 'определение'), ('c', 'произношение')], max_length=3, verbose_name='Ошибка в')),
                ('error_text', models.TextField(blank=True, verbose_name='Подробнее об ошибки')),
            ],
        ),
    ]
